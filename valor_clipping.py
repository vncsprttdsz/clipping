...
COVERAGE = {
    ...
    "MELI":   ["mercadolibre", "mercado libre", "mercado livre",
               "mercado pago", "meli"],
    "NU":     ["nubank", "nu holdings", "nu pagamentos"],
    "VIVA3":  ["vivara", "life by vivara"],
    "AZZA3":  ["azzas", "arezzo", "grupo soma", "hering", "farm",
               "animale", "schutz", "reserva", "anacapri"],
}

SECTOR_KEYWORDS = {
    "labor_reform": [
        "reforma trabalhista", "escala 6x1", "escala 5x2",
        "jornada 40 horas", "jornada de 40", "jornada 44 horas",
        "pec trabalhista", "horas extras", "pec da jornada",
    ],
    "tax_reform": [
        "reforma tributaria", "ibs", "cbs", "imposto seletivo",
        "cesta basica nacional", "trava do iva",
    ],
    "icms_st": [
        "substituicao tributaria", "icms-st", "portaria sre",
        "difal", "convenio icms",
    ],
    "consumer_macro": [
        "pmc", "pesquisa mensal do comercio", "vendas no varejo",
        "massa salarial", "renda real", "endividamento das familias",
        "comprometimento de renda", "inadimplencia",
        "bolsa familia", "salario minimo", "cadastro positivo",
    ],
    "ecommerce_cross_border": [
        "remessa conforme", "taxa das blusinhas", "us$ 50",
        "shein", "shopee", "temu", "aliexpress",
    ],
    "competitive_entry": [
        "h&m", "inditex", "zara", "uniqlo", "primark",
        "costco", "walmart brasil",
    ],
}
